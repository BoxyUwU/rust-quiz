...
<!-- 
    FIXME: Like trait_solver/4 this example is effectively the same as borrowck/2.
        we should probably move this into borrowck/2's solution as a fun fact about
        what `fn(_)` means and what implications that has due to universes
 -->
