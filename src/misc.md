...
For each code example on each page, when running `cargo run` what does the example output.
This may be a compiler error, a runtime panic, some kind of runtime logging, etc.
