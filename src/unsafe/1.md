...
```rust
{{#include ../../code/examples/unsafe_1_1.rs:matters}}
```

```rust
{{#include ../../code/examples/unsafe_1_2.rs:matters}}
```

```rust
{{#include ../../code/examples/unsafe_1_3.rs:matters}}
```

```rust
{{#include ../../code/examples/unsafe_1_4.rs:matters}}
```

```rust
{{#include ../../code/examples/unsafe_1_5.rs:matters}}
```
